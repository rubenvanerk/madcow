        ...
        @empty
            <div class="w-full flex justify-center">
                ...
                @if (!$past)
                    ...
                    <button type="button" class="relative block w-full border-2 border-gray-300 border-dashed rounded-lg p-12 text-center hover:border-gray-400" wire:click="generateWorkouts">
                        ...
                        <span class="mt-2 block text-sm font-medium text-gray-900 dark:text-gray-200">
                ...
                @else
                    <p class="text-gray-900 dark:text-gray-200">You have no completed workouts.</p>
                @endif
